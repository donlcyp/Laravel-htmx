...
<?php endif; ?>
    ...
    <form method="POST" action="<?php echo e(route('login')); ?>" hx-post="<?php echo e(route('login')); ?>" hx-target="this" hx-swap="innerHTML">
        <?php echo csrf_field(); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.primary-button','data' => ['class' => 'ms-3','hxDisable' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'ms-3','hx-disable' => true]); ?>
...
<?php endif; ?>
<?php /**PATH D:\xampp\htdocs\Laravel-crud - Copy\resources\views/auth/login.blade.php ENDPATH**/ ?>